...
from mindnlp.transformers import GitConfig, GitProcessor, GitVisionConfig, is_mindspore_available, is_vision_available
...
from mindnlp.utils.testing_utils import require_mindspore, slow, require_vision
